...
function convertTemperature(temp, str) {
    ...
    if (str === 'C') {
        ...
        return `${(temp * 9 / 5) + 32} ${str = 'Fahrenheit'}`

    }
    else if (str === 'F') {

        return `${(temp - 32) * 5 / 9} ${str = 'Celsius'}`

    }
    else {

        return `error you must enter the temp with C or F`
    }
}
...
This function should return the count of
